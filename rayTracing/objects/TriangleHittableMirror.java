...
public class TriangleHittableMirror extends Hittable {
	...
	public TriangleHittableMirror(VectorDouble Pa, VectorDouble Pb, VectorDouble Pc) {
		origin = Pa.getY();
		record = new HitRecord();
